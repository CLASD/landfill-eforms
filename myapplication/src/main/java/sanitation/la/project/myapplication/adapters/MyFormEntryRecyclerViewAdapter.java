...
import sanitation.la.project.myapplication.ui.ItemFragment.OnListFragmentInteractionListener;
 ...
 */
public class MyFormEntryRecyclerViewAdapter extends RecyclerView.Adapter<MyFormEntryRecyclerViewAdapter.ViewHolder> {

    private final List<Double> mValues;
    private final OnFragmentInteractionListener mListener;

    public MyFormEntryRecyclerViewAdapter(List<Double> items, OnFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
