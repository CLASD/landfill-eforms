...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_INSTANTANEOUS_TABLE = "CREATE TABLE IF NOT EXISTS" + TABLE_INSTANTANEOUS +
                "(" +
                KEY_INSTANTANEOUSDATAPK + " INTEGER PRIMARY KEY," + KEY_SITEPK + " INTEGER," +
                KEY_EMPLOYEEPK + " INTEGER," + KEY_STARTTIME + " DATETIME," + KEY_FINISHTIME + " " +
                "DATETIME," + KEY_INSTRUMENTPK + " INTEGER," + KEY_MAXCH + " VARCHAR(45)," +
                KEY_SITESAMPLINGPOINTPK + " INTEGER" + ")";
    ...
    // add
    void addInstantaneous(Instantaneous instantaneous) {
    ...
    public List<Instantaneous> getAllInstantaneous() {
        ...
        if(cursor.moveToFirst()) {
            do {
                ...
                instantaneous.setMaxCH(cursor.getString(6));
